...
void codec2_encode(uint16_t index[], int16_t speech[]) {
    /*
...
void codec2_decode(int16_t speech[], uint16_t index[]) {
...
float codec2_get_energy(uint16_t index[]) {
